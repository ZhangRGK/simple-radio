...
Radio = (function(superClass) {
  ...
  Radio.prototype._init = function() {
    ...
    this.on = this.radio.prop("on");
    this.size = this.radio.data("size") ? this.radio.data("size") : 32;
    return this._render();
  };
  ...
  Radio.prototype._render = function() {
    ...
    this.el.css("height", this.size);
    this.el.css("width", this.size * 1.6);
    this.el.css("border-radius", this.size);
